...
async function loginHandler(req, res) {
    ...
    try {
        // Busca o responsável
        const caregiverResult = await db_1.default.query(`SELECT caregiver_id, caregiver_name_official 
       FROM caregivers 
       WHERE caregiver_phone = $1 AND is_active = true`, [phone]);
        ...
        const studentsResult = await db_1.default.query(`SELECT 
         s.student_id,
       ...
       WHERE sc.caregiver_id = $1 AND s.is_active = true`, [caregiver.caregiver_id]);
